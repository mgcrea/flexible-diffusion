...
type ProgressStatus = "idle" | "pending" | "loading" | "succeeded" | "failed";
...
export const PromptProgress: FunctionComponent<PromptProgressProps> = ({
  progress,
  status,
  ...otherProps
}) => {
  ...
  return (
    <div
      className={classNames("w-auto h-1 mx-1 rounded-b-full", outerClassName)}
    >
      <div
        className={classNames(
          "w-[1%] h-1 origin-left bg-blue-600 rounded-b-full",
          innerClassName
        )}
        style={{
          width: `${progress}%`,
